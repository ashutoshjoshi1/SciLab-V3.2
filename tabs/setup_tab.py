...
def build(app):
    ...
    style = ttk.Style()
    style.configure('Setup.TLabelframe.Label', font=('TkDefaultFont', 11, 'bold'))
    style.configure('Setup.TLabelframe', padding=12)
    style.configure('SetupLabel.TLabel', font=('TkDefaultFont', 10))
    style.configure('SetupStatus.TLabel', font=('TkDefaultFont', 10, 'bold'))
    style.configure('SetupButton.TButton', font=('TkDefaultFont', 10), padding=6)
    style.configure('SetupAction.TButton', font=('TkDefaultFont', 10, 'bold'), padding=8)
    ...
    def _build_setup_tab():
        ...
        title_frame.pack(fill="x", padx=10, pady=(0, 12))
        ttk.Label(title_frame, text="⚙️ System Configuration", 
        ...
        app.dll_entry = ttk.Entry(spec_group, width=70, font=('TkDefaultFont', 10))
        ...
        app.obis_entry = ttk.Entry(ports_group, width=15, font=('TkDefaultFont', 10))
        app.cube_entry = ttk.Entry(ports_group, width=15, font=('TkDefaultFont', 10))
        app.relay_entry = ttk.Entry(ports_group, width=15, font=('TkDefaultFont', 10))
        ...
        app.headsensor_entry = ttk.Entry(headsensor_group, width=15, font=('TkDefaultFont', 10))
        ...
        ttk.Label(stage_group, text="Config File:",
                 style='SetupLabel.TLabel').grid(row=0, column=0, sticky="e", padx=8, pady=6)
        app.stage_config_entry = ttk.Entry(stage_group, width=50, font=('TkDefaultFont', 10))
        ...
        ttk.Label(stage_group, text="Stage COM:",
                 style='SetupLabel.TLabel').grid(row=1, column=0, sticky="e", padx=8, pady=6)
        app.stage_com_entry = ttk.Entry(stage_group, width=15, font=('TkDefaultFont', 10))
        ...
        ttk.Label(header_frame, text="Wavelength", 
                 ...
                 foreground="#555").pack(side="left", padx=(2, 90))
        ttk.Label(header_frame, text="Type", 
                 font=('TkDefaultFont', 9, 'bold'),
                 foreground="#555").pack(side="left", padx=(0, 80))
        ...
        def add_laser():
            ...
            ttk.Label(wl_frame, text="Wavelength (nm):", 
                     font=('TkDefaultFont', 10)).pack(side="left", padx=(0, 12))
            wl_entry = ttk.Entry(wl_frame, width=15, font=('TkDefaultFont', 10))
            wl_entry.pack(side="left")
            wl_entry.insert(0, "532")  # Default value
            ttk.Label(wl_frame, text="e.g., 405, 532, 638", 
                     foreground="gray", font=('TkDefaultFont', 8)).pack(side="left", padx=(8, 0))
            
            # Type selection
            type_frame = ttk.Frame(dialog_frame)
            type_frame.pack(fill="x", pady=8)
            ttk.Label(type_frame, text="Laser Type:", 
                     font=('TkDefaultFont', 10)).pack(side="left", padx=(0, 32))
            ...
            ttk.Label(power_frame, text="Power (mW):", 
                     font=('TkDefaultFont', 10)).pack(side="left", padx=(0, 35))
            power_entry = ttk.Entry(power_frame, width=15, font=('TkDefaultFont', 10))
            ...
            save_btn = ttk.Button(button_frame, text="💾 Save & Add Laser", command=on_confirm,
                                 style='SetupAction.TButton', width=20)
            ...
            # Add help text below buttons
            ttk.Label(dialog_frame, text="Click 'Save & Add Laser' to add this laser to the system", 
                     foreground="#666", font=('TkDefaultFont', 8, 'italic')).pack(pady=(4, 0))
            ...
            if result["confirmed"]:
                ...
                messagebox.showinfo("✅ Laser Added & Saved", 
        ...
        def remove_laser():
            ...
            if confirm:
                ...
                messagebox.showinfo("✅ Laser Removed & Saved", 
        ...
        ttk.Label(laser_mgmt_group, text="💡 Tip: Laser changes are saved automatically when you add or remove lasers.", 
                 foreground="#0066cc", font=('TkDefaultFont', 9, 'italic')).pack(anchor="w", padx=8, pady=(6, 4))
        ...
        def rebuild_power_entries(force=False):
            ...
            for group_index in range(column_groups):
                ...
                ttk.Label(power_group, text="Wavelength", 
                         font=('TkDefaultFont', 9, 'bold'),
                         foreground="#555").grid(row=header_row, column=col_offset, sticky="w", padx=(12, 0), pady=(2, 8))
                ttk.Label(power_group, text="Type", 
                         font=('TkDefaultFont', 9, 'bold'),
                         foreground="#555").grid(row=header_row, column=col_offset + 1, sticky="w", padx=(4, 0), pady=(2, 8))
                ttk.Label(power_group, text="Power", 
                         font=('TkDefaultFont', 9, 'bold'),
                         foreground="#555").grid(row=header_row, column=col_offset + 2, sticky="w", padx=(0, 0), pady=(2, 8))
            ...
            for idx, wavelength in enumerate(sorted_lasers):
                ...
                # Type badge
                type_colors = {"OBIS": "#0066cc", "CUBE": "#cc6600", "RELAY": "#009933"}
                ...
                # Power entry
                e = ttk.Entry(power_group, width=10, font=('TkDefaultFont', 10))
    ...
    def show_spectrometer_selection_dialog(devices):
        ...
        ttk.Label(dialog_frame, 
                 text="Tip: You can also double-click to select and connect", 
                 foreground="#666", 
                 font=('TkDefaultFont', 8, 'italic')).pack(pady=(4, 0))
